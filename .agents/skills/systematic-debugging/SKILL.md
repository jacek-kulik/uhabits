...
description: Diagnose bugs, failed tests, and unexpected behavior in this Android and Kotlin project before changing code.
---
...
4. Make the smallest fix that addresses the cause. Add or update a focused regression test for behavior changes, following `AGENTS.md`; keep Android-only behavior in the Android module and shared behavior in core.
5. Re-run the original reproduction and the relevant tests. Report what was verified and what remains uncertain.
